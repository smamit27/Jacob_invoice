...
import InvoiceOverview from '../../molecules/InvoiceOverview'
import InvoiceDetails from '../../molecules/InvoiceDetails'
import { InvoiceHome } from '../../molecules/InvoiceHome'
import {InvoiceEvents} from '../../molecules/EventsSummary'
import CreateEventInvoiceTableList from "../../molecules/EventsSummary/CreateEventInvoiceTableList";
import CreateEventDetailseProjectNumTableList from "../../molecules/EventsSummary/CreateEventDetailseProjectNumTableList";
...
export default function Invoice() {
  ...
  const TabContent = [
    ...
    },
    {
      ...
      // component: () => <div>Invoice Overview</div>,

      component: (props) => <InvoiceOverview {...props} />,
      moduleId: 27,
      udf: false
    },
    {
      name: 'Invoice Details',
      component: (props) => <InvoiceDetails {...props} />,
      // component: () => <div>Invoice Details</div>,
    ...
    {
      name: 'EventsSummary',
      component: (props) => <InvoiceEvents {...props} />,
    ...
    {
      name: 'Preview Invoice & Reports',
      component: () => <div>Preview Invoice & Reports</div>,
      moduleId: 30,
      udf: false
    },
    {
  ...
  const { moduleId = "26", filters, ...rest } = parse(location.search)
  ...
  return (
    <div className={classes.root}>
      <Loader loading={loading} error={error} style={{ height: "calc(100vh - 80px)" }} >
        ...
        {renderTabPanel()}
        {console.log("user log two", isCreateEventOfInvoicesModelOpen)}
        {isCreateEventOfInvoicesModelOpen && <CreateEventInvoiceTableList />}
        {iscreateEventDetaliseOfInvoicesModelOpen && <CreateEventDetailseProjectNumTableList />}
        <UserDefineFields />
